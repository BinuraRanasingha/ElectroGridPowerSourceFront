...
public class PowerSourceAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = ps.insertPowerSource(request.getParameter("pName"),
				request.getParameter("address"),
				request.getParameter("province"),
				request.getParameter("powerSourceType"),
				request.getParameter("power"),
				request.getParameter("mDay"),
				request.getParameter("engID"));
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = ps.updatePowerSource(paras.get("hidPowerIDSubmit").toString(),
				...
				paras.get("powerSourceType").toString(),
				paras.get("power").toString(),
				paras.get("mDay").toString(),
				paras.get("engID").toString());
